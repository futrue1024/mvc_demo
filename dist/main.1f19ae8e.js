...
},{"./bundle-url":"../../../Users/apple/AppData/Local/Yarn/Data/global/node_modules/parcel/src/builtins/bundle-url.js"}],"reset.css":[function(require,module,exports) {
...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../../Users/apple/AppData/Local/Yarn/Data/global/node_modules/parcel/src/builtins/css-loader.js"}],"../../../Users/apple/AppData/Local/Yarn/Data/global/node_modules/process/browser.js":[function(require,module,exports) {
...
var eventBus = (0, _jquery.default)(window); //设定事件，监听触发事件。
//数据相关放到m
...
var v = {
  ...
  render: function render(n) {
    if (v.container.children.length === 0) {
      (0, _jquery.default)(v.html.replace("{{n}}", n)).prependTo((0, _jquery.default)(v.container));
    } else {
      v.container.empty();
      (0, _jquery.default)(v.html.replace("{{n}}", n)).prependTo((0, _jquery.default)(v.container));
    }
...
var v = {
  ...
  html: function html(index) {
    return "\n  <div>\n  <ol id=\"tab-bar\">\n  <li class=\"".concat(index === 0 ? "active" : null, "\" data-index='0'>1111</li>\n  <li class=\"").concat(index === 1 ? "active" : null, "\" data-index='1'>2222</li>\n  </ol>\n  <ol id=\"content\">\n    <li class=\"").concat(index === 0 ? "active" : null, "\" >\u9009\u62E91111</li>\n    <li class=\"").concat(index === 1 ? "active" : null, "\">\u9009\u62E92222</li>\n  </ol>\n  </div>\n");
  },
  init: function init(container) {
    v.container = (0, _jquery.default)(container);
  },
  render: function render(index) {
    if (v.container.children.length === 0) {
      (0, _jquery.default)(v.html(index)).prependTo((0, _jquery.default)(v.container));
    } else {
      v.container.empty();
      (0, _jquery.default)(v.html(index)).prependTo((0, _jquery.default)(v.container));
    }
...
var c = {
  ...
  x: function x(e) {
    ...
    var liIndex = parseInt(e.currentTarget.dataset.index);
    console.log(liIndex);
    m.update({
      index: liIndex
    });
